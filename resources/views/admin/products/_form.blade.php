...
<div class="admin-tabs" data-admin-tabs>
    <div class="admin-tabs-nav" role="tablist">
        @foreach ($productTabLabels as $tabKey => $tabLabel)
            <button
                type="button"
    ...
    <div class="admin-tab-panel active" data-tab-panel="basic" role="tabpanel">
        <div class="form-row">
    ...
    <div class="admin-tab-panel" data-tab-panel="categories" role="tabpanel">
        <div class="form-group" style="margin-bottom:0">
    ...
    <div class="admin-tab-panel" data-tab-panel="pricing" role="tabpanel">
        <div class="form-row">
            <div class="form-group">
                <label class="form-label" for="price">Цена, ₽</label>
                <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $product->price ?? '') }}" min="0" step="0.01">
                <div class="form-help">Оставьте пустым или укажите 0, если цену нужно уточнять у менеджера.</div>
    ...
    <div class="admin-tab-panel" data-tab-panel="parameters" role="tabpanel">
        <div class="form-row">
            <div class="form-group">
        ...
        <div class="form-row" style="margin-bottom:0">
            <div class="form-group">
                ...
                @error('color')<div class="form-help" style="color:var(--danger)">{{ $message }}</div>@enderror
            </div>
            <div class="form-group">
                <label class="form-label" for="composition">Состав</label>
                <input type="text" id="composition" name="composition" class="form-control @error('composition') is-invalid @enderror" value="{{ old('composition', $product->composition ?? '') }}">
                @error('composition')<div class="form-help" style="color:var(--danger)">{{ $message }}</div>@enderror
            </div>
        </div>
    </div>

    <div class="admin-tab-panel" data-tab-panel="attributes" role="tabpanel">
        <div class="d-flex justify-content-between align-items-center" style="margin-bottom:12px">
            <div class="form-help" style="margin:0">Произвольные характеристики товара (название/значение).</div>
    ...
    <div class="admin-tab-panel" data-tab-panel="gallery" role="tabpanel">
