...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            if ($parentId && app(CategoryService::class)->getDescendantIds($category)->contains((int) $parentId)) {
                $validator->errors()->add('parent_id', 'Нельзя выбрать дочернюю категорию в качестве родителя.');
            }
